 ...
 * @brief R60ABD1 雷达数据接收、解析、BLE 交互和数据分发实现。
 *
 * 这是雷达硬件的核心模块，负责串口帧、实时状态及相关命令处理。
 */
...
void initRadarManager() {
    ...
    #else
    Serial.println("[InfluxDB] 默认自有服务器构建已关闭直写任务");
    #endif
