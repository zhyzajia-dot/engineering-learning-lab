...
def run_gimbal_auto(
    ...
    """Run Guard23 line/turn learning in one continuous square session."""
    ...
    try:
        ...
        # All preparation is RAM-only.  Guard23 performs the sole Flash SAVE
        ...
        print(
            "GIMBAL AUTO Guard23: no fixed qualification lap. The first "
