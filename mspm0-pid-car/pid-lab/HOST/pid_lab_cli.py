...
def run_gimbal_auto(
    ...
    """Run Guard8 line/turn learning in one continuous square session."""
    ...
    try:
        ...
        # All preparation is RAM-only.  Guard8 performs the sole Flash SAVE
        ...
        print(
            "GIMBAL AUTO Guard8: no fixed qualification lap. The first "
